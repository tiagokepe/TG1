...
\title{Transformações de Data Warehouse para MapReduce no projeto ProInfoData}
\author{Tiago Rodrigo Kepe e Felipe Bolsi}
\advisortitle{Orientador} % ou Orientador
\advisorname{Profa. Dr. Eduardo Almeida}
...
{Prof. Dr. Educardo Almeida}{Departamento de Informática, UFPR} % se nao houver deixe em branco {}{}
