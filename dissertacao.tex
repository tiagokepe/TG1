...
\title{Migra\c{c}\~{a}o de Data Warehouse para MapReduce no projeto ProInfoData}
\author{Tiago Rodrigo Kepe e Felipe Bolsi}
\advisortitle{Orientador} % ou Orientador
\advisorname{Prof. Dr. Eduardo Almeida}
\advisorplace{Departamento de Inform\'{a}tica, UFPR}  % departamento, instituicao
\city{Curitiba}
\year{2011}
...
\input{./text/resumo.tex}           % somente o texto
\newpage

\chapter*{Abstract}
\addcontentsline{toc}{chapter}{\MakeUppercase{Abstract}}
\input{./text/abstract.tex}        % somente o texto
\newpage


\pagenumbering{arabic}

\input{./text/capitulo1.tex}
\input{./text/capitulo2.tex}
\input{./text/capitulo3.tex}
\input{./text/capitulo4.tex}
\input{./text/capitulo5.tex}
%\input{capitulo6.tex}
