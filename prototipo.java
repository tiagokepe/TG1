/* Protótipo de implementação de map e reduce 
 * Tiago Rodrigo Kepe 
 */
...
public class Availability {
    ...
    public static class Map extends MapReduceBase 
      implements Mapper<LongWritable , Text , LongWritable , Text> {
        ...
        /* Implementacao da função de mapeamento . */
        public void map( LongWritable key , Text value,
          OutputCollector<LongWritable, Text> output, Reporter reporter
            ...
            /* Verifica se o campo data-contato é data atual */
            if (fields[6].equals(strDate)) {

                /* Emite um par chave/valor intermediario, contendo a data de
                   contato(chave) e região como string(valor). */
                k.set(strData);
    ...
    public static class Reduce extends MapReduceBase
      implements Reducer<LongWritable, Text, LongWritable, Text> {
        ...
        /* Implementacao da função de redução. */
        public void reduce (LongWritable key , Iterator <Text> values,
          Output Collector <LongWritable, Text> output, Reporter reporter
            ...
            /* Percorre os registro do dia atual e classifica o número de
            contatos por região */
            while (values.hasNext()) {

                String region = values.next().toString();
                /* Pega o região e data. */
    ...
    public static void main (String[] args) throws Exception {
        ...
        /* Define a quantidade de tarefas de redução. */
        conf.setNumReduceTasks(1) ;

        /* Define o tipo dos pares chave/valor de saída. */
        conf.setOutputKeyClass(LongWritable.class);
        conf.setOutputValueClass(Text.class);

        /* Indica as classes que implementam o mapeamento e redução. */
        conf.setMapperClass(Map.class);
        conf.setReducerClass(Reduce.class);

        /* Indica o tipo dos arquivos de entrada e saída. */
